/*
Files are an essential part of any program as we can take input from and print output in files. We can also save a lot of program space by accessing the file's data only when needed, making the program more efficient and faster.
